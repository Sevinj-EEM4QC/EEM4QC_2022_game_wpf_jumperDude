...
namespace jumperDude
{
    static class UIEffects
    {
        ...
        {
            UIEffects.IngameScreenBackground_1(a, a1, speed / 16, x, windowWidth, leftCollison, rightCollison);
            UIEffects.IngameScreenBackground_1(b, b1, speed / 8, x, windowWidth, leftCollison, rightCollison);
            UIEffects.IngameScreenBackground_1(c, c1, speed / 4, x, windowWidth, leftCollison, rightCollison);
            UIEffects.IngameScreenBackground_1(d, d1, speed / 2, x, windowWidth, leftCollison, rightCollison);
            UIEffects.IngameScreenBackground_1(f, f1, speed, x/1.3, windowWidth, leftCollison, rightCollison);
        }
    }
